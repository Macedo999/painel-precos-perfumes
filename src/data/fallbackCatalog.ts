...
export const fallbackCatalog: LiveSearchResult[] = [
  {
    ...
    product: { name: 'Perfume Carolina Herrera 212 VIP Eau de Parfum Feminino 80ML', volumeMl: 80, url: 'https://www.comprasparaguai.com.br/perfume-carolina-herrera-212-vip-eau-de-parfum-feminino-80ml_3140/', priceUsd: 65, priceBrl: 338 }, alternatives: [], marketplaces: [],
  ...
  },
  {
    ...
    product: { name: 'Perfume Carolina Herrera 212 Eau de Toilette Feminino 60ML', volumeMl: 60, url: 'https://www.comprasparaguai.com.br/perfume-carolina-herrera-212-eau-de-toilette-feminino-60ml_798/', priceUsd: 49.5, priceBrl: 257.4 }, alternatives: [], marketplaces: [],
